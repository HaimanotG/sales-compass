...
export const SIGNAL_TEMPLATES = [
  {
    ...
    text: [
      "Hi {founder_name}, [hook, rewrite into one human line: {change_competitor} just {change_detail}]. Figured you would want to see it before your customers do.",
  ...
  },
  {
    ...
    text: [
      "Hi {founder_name}, [hook, rewrite into one human line: {change_competitor} just {change_detail}]. Usually a short window to catch their demand before they restock.",
  ...
  },
  {
    ...
    text: [
      "Hi {founder_name}, [hook, rewrite into one human line: {change_competitor} just {change_detail}]. The kind of thing that quietly pulls sales if you don't see it early.",
